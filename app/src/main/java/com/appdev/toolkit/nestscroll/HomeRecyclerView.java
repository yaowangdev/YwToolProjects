...
public class HomeRecyclerView extends RecyclerView implements NestedScrollingParent {
    ...
    private OnScrollableChildCallback mOnScrollableChildCallback = new OnScrollableChildCallback() {
        ...
        public void onScrollableChildSelected(ScrollableChild paramAnonymousScrollableChild) {
            ...
            HomeRecyclerView.this.mScrollableView = mScrollableChild.getRecyclerView();
        }
    };
    ...
    private void debugLog(String paramString) {
            LogUtils.e("HomeRecyclerView", paramString);
    }
    ...
    public boolean isScrollableViewShown() {
        ...
        this.mScrollableView = this.mScrollableChild.getRecyclerView();
    ...
    public static abstract interface OnScrollableChildCallback {
        public abstract void onScrollableChildChangedToIdle(RecyclerView paramRecyclerView);

        public abstract void onScrollableChildSelected(ScrollableChild paramScrollableChild);
    }
