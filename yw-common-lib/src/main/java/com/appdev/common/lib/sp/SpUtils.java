...
public class SpUtils {
            ...
            synchronized (SpUtils.class){
                if(mInstance ==null){
                    mInstance = context.getApplicationContext()
                            .getSharedPreferences("SharePreferenceUtils", Context.MODE_PRIVATE);
                }
            }
        }
        return mInstance;
     ...
     * @param key
     */
    public static void removeSharePreferences(Context context, String key) {
        SharedPreferences sharePre = getInstance(context);
